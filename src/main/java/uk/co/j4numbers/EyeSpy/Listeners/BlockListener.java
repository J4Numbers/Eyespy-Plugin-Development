package uk.co.j4numbers.EyeSpy.Listeners;
...
public class BlockListener implements Listener {
	...
	/**
	 * Block Break listener. Once a block is broken, it sends the variables to the uk.co.j4numbers.EyeSpy.Logging.Logging class to be placed into the SQL string, 0 means break.
	...
	/**
	 * Block Place listener. Once a block is broken, it sends the variables to the uk.co.j4numbers.EyeSpy.Logging.Logging class to be placed into the SQL string, 1 means place.
